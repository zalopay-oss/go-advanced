...
### 6.4.3 Truy vấn DSL ([Domain-specific Language](https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl.html))
...
### 6.4.4 Sử dụng client SDK của Elaticsearch
...
### 6.4.6 Đồng bộ hóa dữ liệu không đồng nhất
...
#### 6.4.1 Đồng bộ dữ liệu theo timestamp
...
### 6.4.2 Đồng bộ hóa dữ liệu với binlog
