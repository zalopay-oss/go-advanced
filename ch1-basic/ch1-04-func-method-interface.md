...
> Languages ​​that try to disallow idiocy become themselves idiotic (Các ngôn ngữ cố gắng tránh các hành vi ngu ngốc cuối cùng trở thành ngôn ngữ ngu ngốc).
...
Như  đã đề cập trong phần Method, ta có thể kế thừa các phương thức của  kiểu ẩn danh bằng cách nhúng các thành phần thuộc  kiểu đó vào struct. Trong thực tế, thành viên ẩn danh nhúng này không nhất thiết phải là một loại bình thường, mà còn là một loại interface. Chúng ta có thể testing.TBgiả mạo các privatephương thức riêng tư bằng cách nhúng các interface ẩn danh , bởi vì các phương thức interface là các ràng buộc lười biếng và privatekhông thành vấn đề nếu các phương thức biên dịch thời gian thực sự tồn tại.
