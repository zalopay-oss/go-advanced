...
Đối với các công ty Internet hiện có service 24/7, việc không đảm bảo service chạy là vấn đề rất quan trọng. Mặc dù kiến trúc công nghệ của tầng lưu trữ đã trải qua nhiều năm phát triển, nó vẫn là phần dễ bị hư hại nhất trong toàn bộ hệ thống. Thời gian chết hệ thống  là tổn thất kinh tế trực tiếp cho các công ty cung cấp service 24/7.  Do đó nguy cơ này không thể bỏ qua.

Từ góc độ phân ngành, các công ty Internet ngày nay có các DBA toàn thời gian. Hầu hết các DBA không nhất thiết phải có khả năng code. Từ quan điểm của DBA, tôi vẫn hy vọng sẽ có một cơ chế kiểm toán SQL đặc biệt để có được tất cả nội dung SQL của hệ thống với chi phí thấp, thay vì đọc code SQL Builder có liên quan do bộ phận bussiness development viết.
